...
srcObjects = $(addprefix $(buildDir_ColorConsole)/, $(sources:.cpp=.o))
...
$(srcObjects): $(buildDir_ColorConsole)/%.o: $(srcDir)/%.cpp
	@echo [CXX] -c $< -o $@
	@$(CXX) $(CXXFLAGS) -c $< -o $@

prepare:
	@mkdir -p $(buildDir_ColorConsole)
